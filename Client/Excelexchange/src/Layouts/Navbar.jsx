    ...
    <div
      className={`${
        hideScrolling
          ...
          : "bg-base-200 bg-opacity-95 dark:bg-black navbar top-0 mx-auto left-0 right-0 w-full border-b-gray-700 border-b-[0.6px] z-50 transition-all duration-300"
      }`}>
      {showMenu && (
        <div
          ...
          <div className="flex items-center">
            <Link to="/" className="font-extrabold flex items-center text-xl">
              <motion.img
                ...
                animate={{
                  scale: [1, 1.1, 1.12, 1.13, 1],
                  rotate: ["0deg", "15deg", "30deg", "60deg", "0deg"],
                }}
                transition={{
                  ease: "circInOut",
                  duration: 1.5,
