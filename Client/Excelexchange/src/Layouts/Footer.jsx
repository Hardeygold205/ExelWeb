...
export default function Footer() {
  ...
  return (
    <div className="bg-base-200 text-base-content p-3 md:p-10">
              ...
              <div className="flex space-x-2 mt-4">
                {socialLinks.slice(0, 5).map((social, index) => (
                  <Link
                    key={index}
                    to={social.link}
                    className="rounded-full outline outline-gray-300 p-1 hover:outline-blue-800 hover:scale-110 flex justify-center items-center">
                    {social.icon}
                  </Link>
                ))}
              </div>
      ...
      <div className="divider mx-auto max-w-7xl"></div>
      <footer className="footer bg-base-200 text-base-content border-base-300 border-t p-4 max-w-7xl mx-auto">
